...
public abstract class Animal implements Actor
{
    ...
    public void act(List<Actor> newActors, int in){}
    ...
    protected void giveBirth(List<Actor> newAnimals) {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            ...
            Actor young = getNewAnimal(true, field, loc);
            newAnimals.add(young);
        }
    }

    abstract protected Actor getNewAnimal(boolean tf, Field field, Location loc);
