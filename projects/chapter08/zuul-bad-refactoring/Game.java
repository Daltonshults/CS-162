...
public class Game 
{
    ...
    private void chargeBeamer() {
        ...
        System.out.println("Your beamer is now charged to teleport you to: " + player.getBeamer().getShortDescription());
    }
    
    private void fireBeamer() {
        if (player.getBeamer() != null) {
            for (Item i : player.getBag()) {
