...
public class Room 
{
     ...
     * @return the value of the locked door
     */
    ...
    /**
     * Makes it so you can set a door lock from a boolean
     * @param set if the door is locked if it is true door is unlocked if false
     */
