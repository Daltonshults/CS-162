...
public class AddressBookTextInterface
{
    ...
    /**
     * prints the details of the individual you are looking for
     */
    private void getDetailsInt() {
        System.out.println("Who's details? ");
        String prefix = parser.readLine();
        ContactDetails cd = book.getDetails(prefix);
        if (cd != null) {
            System.out.println(cd.getName() + " " + cd.getPhone() + " " + cd.getAddress());       
        } else {
            System.out.println("The name was not found. Please search with full name");
        }
    }
    
    /**
     * removes the details of the string entered.
     */
    private void removeDetailsInt() {
        System.out.println("Who's details? ");
        String prefix = parser.readLine();
        book.removeDetails((String) prefix);        
    }
