...
public class AddressBook
{
    ...
    {
        if(oldKey != null && details != null) {
            removeDetails(oldKey); //Check done within method
            addDetails(details); //Check done within method
        }
    }
    ...
    public TreeMap<String, ContactDetails> getBook() {
        return book;    
    }
}
