...
public class ContactDetails implements Comparable<ContactDetails>
{
    ...
    public ContactDetails(String name, String phone, String address)
    {
        ...
        if(name == null) {
            throw new IllegalArgumentException("name in ContactDetails constructor");
        }
        if(phone == null) {
            throw new IllegalArgumentException("phone in ContactDetails constructor");
        }
        if(address == null) {
            throw new IllegalArgumentException("address in ContactDetails constructor");
        }
        this.name = name.trim();
